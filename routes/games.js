...
function GameHandler(request, cheerio) {
	...
	this.getFenwickEvents = function(req, res) {
		...
		playByPlay(season, gametype, gameid, function(gamedata) {
			var fenwick = new Object();

			fenwick['season'] = gamedata.season;
			fenwick['gametype'] = gamedata.gametype;
			fenwick['gameid'] = gamedata.gameid;
			fenwick['home'] = gamedata.home;
			fenwick['away'] = gamedata.away;
			fenwick['gamedate'] = gamedata.gamedate;
			fenwick['gamestart'] = gamedata.gamestart;

			var events = new Array();
			gamedata.events.forEach(function(eventvalue,eventindex) {
				if(eventvalue.fenwick)
	...
	this.getCorsiEvents = function(req, res) {
		var season = parseInt(req.params.season);
		switch(req.params.gametype) {
			case '02':
			case '2':
		...
		playByPlay(season, gametype, gameid, function(gamedata) {
			var corsi = new Object();

			corsi['season'] = gamedata.season;
			corsi['gametype'] = gamedata.gametype;
			corsi['gameid'] = gamedata.gameid;
			corsi['home'] = gamedata.home;
			corsi['away'] = gamedata.away;
			corsi['gamedate'] = gamedata.gamedate;
			corsi['gamestart'] = gamedata.gamestart;
	...
	this.getShotEvents = function(req, res) {
		var season = parseInt(req.params.season);
		switch(req.params.gametype) {
			case '02':
			case '2':
		...
		playByPlay(season, gametype, gameid, function(gamedata) {
			var shots = new Object();

			shots['season'] = gamedata.season;
			shots['gametype'] = gamedata.gametype;
			shots['gameid'] = gamedata.gameid;
			shots['home'] = gamedata.home;
			shots['away'] = gamedata.away;
			shots['gamedate'] = gamedata.gamedate;
			shots['gamestart'] = gamedata.gamestart;
	...
	this.getGoalEvents = function(req, res) {
		var season = parseInt(req.params.season);
		switch(req.params.gametype) {
			case '02':
			case '2':
		...
		playByPlay(season, gametype, gameid, function(gamedata) {
			...
			goals['season'] = gamedata.season;
			goals['gametype'] = gamedata.gametype;
			goals['gameid'] = gamedata.gameid;
			goals['home'] = gamedata.home;
			goals['away'] = gamedata.away;
			goals['gamedate'] = gamedata.gamedate;
			goals['gamestart'] = gamedata.gamestart;
